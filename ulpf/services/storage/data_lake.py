...
class ParquetDataLakeWriter:
    ...
    def write_batch(self, envelopes: list[EventEnvelope]) -> str:
        ...
        for env in envelopes:
            ...
            traffic = ocsf.get("traffic", {}) if isinstance(ocsf.get("traffic"), dict) else {}
            ...
            records.append({
                ...
                "detected_format": str(env.source.detected_format.value if hasattr(env.source.detected_format, 'value') else env.source.detected_format),
